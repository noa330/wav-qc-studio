...
export const workspaces: WorkspaceDefinition[] = [
  ...
  },
  {
    ...
    navLabel: "Speaker",
    title: "스피카",
    subtitle: "화자 검색과 오디오 개선 결과를 백엔드 추론 결과 기준으로 비교합니다.",
    icon: UsersRound,
    metricLabels: ["전체 파일", "작업 중", "완료", "선택 모델"],
    left: { id: "speaker-browser", title: "파일 브라우저", icon: FolderTree, kind: "browser" },
    center: [
      { id: "speaker-progress", title: "진행 테이블", icon: ChartNoAxesColumnIncreasing, kind: "progress" },
  ...
  },
  {
    ...
    navLabel: "Batch QC",
    title: "Batch QC",
    subtitle: "입력 WAV를 자동 전사하고 WordAlign 단어 타임라인을 만든 뒤 배치 QC 데이터셋으로 내보냅니다.",
    icon: BadgeCheck,
    metricLabels: ["소스 행", "표시 행", "화자 그룹", "활성 화자"],
    left: { id: "batch-browser", title: "파일 브라우저", icon: FolderTree, kind: "browser" },
    center: [
      { id: "batch-table", title: "배치 전사 편집", icon: ClipboardCheck, kind: "table" },
    ...
    right: [
      ...
      { id: "batch-detail", title: "모델 설정", icon: Settings2, kind: "settings" },
    ],
  },
  {
    id: "training",
